...
namespace BlogAPI.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        {
            var secrutiyKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_config["Jwt:Key"]));
            var credentials = new SigningCredentials(secrutiyKey, SecurityAlgorithms.HmacSha256);
